...
const REVIEWS_FALLBACK: Review[] = [
  ...
  { nm: 'Марина Д.',      when: 'місяць тому',    av: '#A39177', text: 'Дуже вдячна команді PrimeBud. Якісно, чесно і з повагою до кожної дрібниці. Рекомендую всім, хто шукає надійних підрядників' },
